...
module.exports = {
 ...
 [
  {
    TituloMensagem:'Base para projetos',
  ...
  {
    TituloMensagem:'Processo Seletivo',
  ...
  {
    TituloMensagem:'Gestão de Tasks',
  ...
  {
    TituloMensagem:'Sistema de pontuação',
  ...
  {
    TituloMensagem:'Filtro de Telemarketing',
  ...
  {
    TituloMensagem:'null',
    TituloMensagem:'Cores de Papiro',
